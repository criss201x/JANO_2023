		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			unset ( $atributos );
			{
				if ($resultadoReclamacion) {
					...
					echo "</tbody>";
					echo "</table></div>";
				}else if($resultadoReclamacion[0]['consecutivo_actividad'] == 7){
										...
										$mostrarHtml .="<td align='center' colspan='3'>"."Recuerde que esta respuesta no tiene efecto sobre los resultados finales del concurso.".'<div><br>';
										...
										$tab=1;
										// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
										$esteCampo = 'observaciones_reclamos';
										$atributos ['id'] = $esteCampo;
										$atributos ['nombre'] = $esteCampo;
										$atributos ['tipo'] = 'text';
										$atributos ['estilo'] = 'jqueryui';
