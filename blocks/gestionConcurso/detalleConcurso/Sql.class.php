			...
			case 'buscarSoporte' :
				$cadenaSql=" SELECT DISTINCT";
                        ...
                        case "consultarPerfilConcurso":
                                ...
                                $cadenaSql.=" prf.requisitos_pregrado, ";
                                $cadenaSql.=" prf.requisitos_maestria, ";
                                $cadenaSql.=" prf.requisitos_doctorado, ";
                                $cadenaSql.=" prf.requisitos_docencia, ";
                                $cadenaSql.=" prf.requisitos_grupo_investigacion, ";
                                $cadenaSql.=" est.estado nom_estado, ";
                        ...
                        case "registroPerfilConcurso":
                                ...
                                $cadenaSql .= " '".$variable['requisitos_pregrado']."',";
                                $cadenaSql .= " '".$variable['requisitos_maestria']."',";
                                $cadenaSql .= " '".$variable['requisitos_doctorado']."',";
                                $cadenaSql .= " '".$variable['requisitos_docencia']."',";
                                $cadenaSql .= " '".$variable['requisitos_grupo_investigacion']."',";
                                $cadenaSql .= " 'A' ";
                                $cadenaSql .= " )";
                        ...
                        case "actualizaPerfilConcurso":
                                ...
                                $cadenaSql .= "requisitos_pregrado= '".$variable['requisitos_pregrado']."',";
                                $cadenaSql .= "requisitos_maestria= '".$variable['requisitos_maestria']."',";
                                $cadenaSql .= "requisitos_doctorado= '".$variable['requisitos_doctorado']."',";
                                $cadenaSql .= "requisitos_docencia= '".$variable['requisitos_docencia']."',";
                                $cadenaSql .= "requisitos_grupo_investigacion= '".$variable['requisitos_grupo_investigacion']."',";
