                            ...
                            $mostrarHtml .= "<thead>
                                ...
                                foreach($resultadoEvaluacion as $key=>$value )
                                    {   $estado=$resultadoEvaluacion[$key]['estado'];
                                        ...
                                        $parametro['consecutivo_calendario']=$resultadoFases[0]['consecutivo_calendario'];
                                        ...
                                        if($resultadoReclamo){
                                             ...
                                             $reclamo=$resultadoReclamo[$subKey]['id']." - ".$resultadoReclamo[$subKey]['reclamo'];
                                             $fecha=substr($resultadoReclamo[$subKey]['fecha_registro'],0,10);
                                             $resultado=$resultadoReclamo[$subKey]['resultado'];
                                             $estado = 'Activo';
                                             $observacion=$resultadoReclamo[$subKey]['observacion'];
                                             $codigo=$resultadoReclamo[$subKey]['id_rsta'];

                                             $valorRequisitoBin = $resultadoEvaluacion[$key]['cumple_requisito'] == "Cumple" ? true : false;
                                             $valorReclamoBin = $resultado == "Aplica" ? true : false;
